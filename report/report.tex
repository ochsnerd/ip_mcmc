...
the standard random walk (see also \hyperref[sec:orgc9cd7d7]{Acceptance Probability for Metropolis-Hastings})
...
\section{Results}
\label{sec:org0acdd21}
\subsection{Analytic sampling from a bimodal Gaussian}
\label{sec:org19629ec}
\subsubsection{Setup}
\label{sec:orgdffb610}
...
I ended up using a normal \(\N{0}{1}\) as a prior and the potential described \hyperref[sec:org2d9eda3]{before}, and
