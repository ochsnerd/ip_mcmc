...
the standard random walk (see also \hyperref[sec:org53cfa95]{Acceptance Probability for Metropolis-Hastings})
...
\label{sec:org635c10d}

Works together with the \hyperref[sec:org5e07f4f]{pCNProposer} to achieve the simpler expression for the acceptance
...
\section{Results}
\label{sec:orgf3eb5c4}
\subsection{Analytic sampling from a bimodal Gaussian}
\label{sec:orgc809a89}
\subsubsection{Setup}
\label{sec:org5e6d014}
...
I ended up using a normal \(\N{0}{1}\) as a prior and the potential described \hyperref[sec:orgb7f9a71]{before}, and
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./figures/Stuart_21.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./figures/stuart_wasserstein_convergence_chain_report.png}
...
\paragraph{Result}
\label{sec:orgc4bbfb4}

\subparagraph{Density plot for posterior}
\label{sec:orgaba2daa}
...
\label{sec:org59d78c2}
\subsubsection{Model}
\label{sec:orga50d220}
\paragraph{Burgers' Equation}
\label{sec:org728dbda}
...
\label{sec:orgf3a7c49}

Blabla
\subsubsection{MCMC}
\label{sec:org1c9c329}

\paragraph{Hyperparameter tuning}
\label{sec:org05f3294}
...
\label{sec:org7b177ba}
\begin{enumerate}
\item Convergence over chain length
\label{sec:org44fad1b}
